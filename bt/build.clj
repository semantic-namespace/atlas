(ns build
  "Build script for atlas-bt (behaviour-tree ontology)"
  (:require [clojure.tools.build.api :as b]
            [clojure.java.io :as io]))

(def lib 'io.github.semantic-namespace/atlas-bt)
...
(defn jar [_]
  ...
  (b/write-pom {:class-dir class-dir
                ...
                :scm {:url "https://github.com/semantic-namespace/atlas"
                      ...
                      :tag (str "v" version)}
                :pom-data [[:description "atlas-bt: behaviour-tree ontology for Atlas"]
