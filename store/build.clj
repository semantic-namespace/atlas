(ns build
  "Build script for atlas-store library"
  (:require [clojure.tools.build.api :as b]
            [clojure.java.io :as io]))

(def lib 'io.github.semantic-namespace/atlas-store)
...
(defn jar [_]
  ...
  (b/write-pom {:class-dir class-dir
                ...
                :scm {:url "https://github.com/semantic-namespace/atlas"
                      ...
                      :tag (str "v" version)}
                :pom-data [[:description "Atlas store: canonical registry snapshots and pluggable persistence"]
